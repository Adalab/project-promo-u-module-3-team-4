...
import defaultImgProject from '../../../images/covercut.jpg';
import '../../../styles/layout/form/buttons.scss';

function GetImgProject({
    imgProject = defaultImgProject,
    updateImgProject,
    text = 'Get avatar!',
}) {
...
GetImgProject.propTypes = {
  avatar: PropTypes.string,
  updateAvatar: PropTypes.func.isRequired,
  text: PropTypes.string,
};

export default GetImgProject;
